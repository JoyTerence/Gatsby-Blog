    ...
    <div className="contact-container">
      <div className="contact-container-row">
        <div className="contact-card">
          <a
            href="https://in.linkedin.com/in/joyterencebarnes"
            target="_blank"
        ...
        <div className="contact-card">
          <a
            href="https://github.com/JoyTerence"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="contact-icon">
      ...
      <div className="contact-container-row">
        <div className="contact-card">
          <a
            href="https://medium.com/@joyterencebarnes"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="contact-icon">
        ...
        <div className="contact-card">
          <a
            href="https://www.facebook.com/joy.terence.9"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="contact-icon">
